    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(help_text='Введите телефон для связи', max_length=128, region=None, verbose_name='Телефон для связи')),
                ...
                ('image', models.ImageField(blank=True, help_text='Выберите фото для аватара', null=True, upload_to='users_avatars/', verbose_name='Аватарка')),
            ],
            options={
